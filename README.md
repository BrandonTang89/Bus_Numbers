...
However, an Azure Cognitive Services Key is still necessary for the OCR section of the code. After acquiring one, put it into a ".env" file in the root directory of the repository as shown below.
